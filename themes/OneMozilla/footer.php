  ...
  <div class="wrap">
    ...
    <nav id="nav-meta">
      <ul role="navigation">
        ...
        <li><a href="https://www.mozilla.org/about/legal.html" rel="external"><?php _e('Legal Notices', 'onemozilla'); ?></a></li>
        <li><a href="https://www.mozilla.org/legal/fraud-report/index.html" rel="external"><?php _e('Report Trademark Abuse', 'onemozilla'); ?></a></li>
